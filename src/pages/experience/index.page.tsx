...
const Experiences = () => {
  return (
    <Main>
      ...
      <Text>I work daily with HTML structures, CSS and its pre-processors (SASS, SCSS), javascript and react (using typescript). I also perform maintenance on JSP files and Tag Libraries. In addition, we often use Google platforms for some implementations, such as Google Tag Manager (GTM). All features and patches are done using GIT as version control.</Text>
